...
<header class="main-header">
    ...
    <a href="loginindex.php" class="logo">
        ...
        <span class="logo-mini">
            <!--<img src="img/logo.png" alt="100 Rupee Power Logo" class="logo-default" width="40%" height="85%"/>--><?php echo company_name ;?>
        </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Admin <?php echo company_name ;?></span>
    </a> 
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo company_name ;?> admin</span>
                    </a>
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p><b><?php echo company_name ;?> Admin</b></p>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="list_management.php">
                    <i class="fa fa-list" aria-hidden="true"></i><span>List Management</span>
                </a>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-envelope"></i> <span>Message</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php $msg_cnt= mysqli_num_rows(mysqli_query($con,"SELECT * FROM `message` WHERE to_id='admin' AND status=0"));
                echo $msg_cnt>=1?'<i class="fa fa-bell text-white"></i>':'';
                ?>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                ...
                <ul class="treeview-menu">
                <li><a href="create_message.php"><i class="fa fa-envelope"></i> Create Message</a></li>
                    <li><a href="inbox_message.php"><i class="fa fa-envelope"></i> Inbox Message</a></li>
                    <li><a href="sent_message.php"><i class="fa fa-envelope"></i> Sent Message</a></li>
                </ul>
            </li>
