...
if(isset($_POST['product_add']))
{
	...
	if($cnt>=1){
		...
		mysqli_query($con,"INSERT INTO `product`(`pro_date`,`pro_code`, `pro_name`, `pro_desc`, `mrp`, `discount`, `price`, `maincat`, `subcat`,`youtube_link`,`margin`,`pro_qty`) VALUES ('$dt','".$_POST['pro_code']."','".$_POST['pro_name']."','".$_POST['pro_desc']."','".$_POST['mrp']."','".$_POST['discount']."','".$_POST['price']."','".$_POST['maincat']."','".$_POST['subcat']."','$youtube_link','".$_POST['margin']."','".$_POST['pro_qty']."')")or die('error 1');
...
if(isset($_POST['send_message'])){
	...
	mysqli_query($con,"INSERT INTO `message`(`jdate`, `from_id`, `to_id`, `subject`, `message`) VALUES ('$dt','admin','$user_id','$subject','$message')") or die("message Query error");
