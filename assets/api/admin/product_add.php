            ...
            <div class="row">
                ...
                <div class="col-md-12" >
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <form id="uploadForm" style="margin:10px" action="action.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <input type="number" class="form-control" name="discount" id="discount" required value="0">
                    </div>
                    <div class="form-group col-md-3">
                    <label for="inputPassword4">Selling Price (Inclusive Tax)</label>
                ...
                <div class="row">
                    ...
                    <textarea class="form-control" name="pro_desc" id="editor"></textarea>
                    </div>
                </div>
<hr>
                <div class="row">
                    ...
                    <label> (Width :300px * Height :300px) </label>
                                   <input type="file" class="form-control" id="pic" accept="image/*" onchange="loadFile(event)" required>
                ...
                <div class="box-footer box text-center">
  <button name="product_add" class="btn btn-primary btn-lg"><i class="fa fa-plus-circle"></i> Add Product</button>
  </div>
</form>
...
<script>
  ...
  $( document ).ready(function() {
    ...
    getProImage(1);
                ...
                function getProImage(e){
                    var getProImage='';
                    $.post('action.php',{getProImage:getProImage}).done(function(datas){
